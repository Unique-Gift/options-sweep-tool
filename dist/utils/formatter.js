...
exports.formatSweep = formatSweep;
exports.formatSweepList = formatSweepList;
function formatSweep(sweep) {
    ...
    const distance = Math.abs(((sweep.strike - sweep.currentPrice) / sweep.currentPrice) * 100).toFixed(1);
...
function formatSweepList(sweeps) {
    if (sweeps.length === 0)
        return "No significant sweeps detected.";
    return sweeps
